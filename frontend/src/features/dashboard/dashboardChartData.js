...
export function buildChantierDistribution(byStatus) {
  const entries = Object.entries(byStatus ?? {})
  if (entries.length === 0) {
    return [
      { name: 'planned', value: 4, color: '#6366f1' },
      { name: 'in_progress', value: 6, color: '#14b8a6' },
      { name: 'on_hold', value: 2, color: '#f59e0b' },
      { name: 'completed', value: 3, color: '#8b5cf6' },
    ]
  }

  const palette = ['#6366f1', '#14b8a6', '#3b82f6', '#f59e0b', '#8b5cf6', '#ec4899', '#64748b']
